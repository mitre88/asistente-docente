        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.94fr)]">
            <article className="panel-surface rounded-[2rem] px-6 py-6 sm:px-8 sm:py-8">
              ...
              <p className="mt-4 font-display text-[clamp(2rem,4vw,3rem)] leading-[0.96] tracking-[-0.04em] text-[var(--color-ink)]">
      ...
      <section id="contacto" className="px-4 pb-20 pt-18 sm:px-6 sm:pb-24 sm:pt-24 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <SectionHeading
            ...
            description="La parte operativa queda clara y visible. Todo lo que pidio tu clienta esta conectado en un bloque final que se siente premium y accionable."
          />
