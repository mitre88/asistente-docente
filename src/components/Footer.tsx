    ...
    <footer className="bg-[#060810] border-t border-white/5 py-16">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-3">
              {[
                ...
                <a key={social.label} href="#" className="w-9 h-9 rounded-lg bg-white/5 hover:bg-white/10 flex items-center justify-center text-gray-500 hover:text-gray-300 transition-all" aria-label={social.label}>
          ...
          {/* Links columns */}
          {[
            { title: "Producto", links: ["Funcionalidades", "Precios", "Integraciones", "API", "Changelog"] },
            { title: "Recursos", links: ["Documentación", "Blog Educativo", "Tutoriales", "Centro de Ayuda", "Comunidad"] },
            { title: "Legal", links: ["Términos de Uso", "Política de Privacidad", "Protección de Datos", "Contacto"] },
          ].map((col) => (
            <div key={col.title}>
