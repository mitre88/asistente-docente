    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a
            href="#contacto"
            className="btn-ripple group bg-[var(--color-accent)] hover:bg-[var(--color-accent-dark)] text-white text-sm font-semibold px-6 py-2.5 rounded-full transition-all hover:shadow-lg hover:shadow-green-500/25 flex items-center gap-2"
          >
            <svg
              width="16"
              height="16"
